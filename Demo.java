...
import iiitb.ess201a7.r16108.Fleet16108;
...
public class Demo {
 ...
 public static void main(String[] args) {
  ...
  {
   Fleet f1 = new Fleet16108("blue"); // note: colour currently not used by Display
   pf.addFleet(f1);
   fleets.add(f1);
   
   f1 = new Fleet16108("blue"); // note: colour currently not used by Display
   pf.addFleet(f1);
   fleets.add(f1);
  }
